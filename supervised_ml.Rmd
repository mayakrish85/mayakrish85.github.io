---
title: "Comparing Supervised ML Methods to Model Severe Flu Indicators"
output: 
  html_document:
    toc: true
    toc_float: true
...
![](images/supervised_ml/plr_plot.png){width="70%"}
...
![](images/supervised_ml/mars_cv.png){width="70%"}
...
![](images/supervised_ml/svml_cv.png){width="70%" align="center"}
...
![](images/supervised_ml/svmr_cv.png){width="70%"}
...
![](images/supervised_ml/rf_cv.png){width="60%"}
...
![](images/supervised_ml/ada_cv.png){width="60%"}
...
![](images/supervised_ml/resample_boxplot.png){width="80%"}
